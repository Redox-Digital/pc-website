    ...
    <section className={style.history}>
      <div className="container">
        ...
        <div className={style.history__content}>
          ...
          <div id={style.nav__before} className={style.history__content__nav}>
            {slides.map((slide) => (
              <label
                key={slide.year}
                htmlFor={slide.year.toString()}
                className={`${selectedSlide === slide.year ? style.checked : ''} ${
                  selectedSlide > slide.year ? style.hidden : ''
                }`}
              >
                {slide.year}
                <input
                  type="radio"
                  id={slide.year.toString()}
                  value={slide.year}
                  checked={selectedSlide === slide.year}
          ...
          <div className={style.history__content__slides}>
            {slides.map((slide) => (
              <div
                key={`slide_${slide.year}`}
                className={`${style.slide} ${selectedSlide === slide.year ? '' : style.hide}`}
              >
                <div
          ...
          <div id={style.nav__after} className={style.history__content__nav}>
            {slides.map((slide) => (
              <label
                key={slide.year}
                htmlFor={slide.year.toString()}
